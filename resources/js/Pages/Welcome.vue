        ...
        <div class="mx-auto px-6 py-10">
            ...
            <div class="blog-section">
                    ...
                    <form @submit.prevent="submit" id="blogForm" class="mt-6 space-y-6 w-full">
                        <div class="rounded-lg bg-gray-200 p-0">
                            <div class="flex">
                                ...
                                <Link :href="route('homepage')" class="bg-blue-600 p-2 rounded-tr-lg rounded-br-lg text-white font-semibold hover:bg-blue-800 transition-colors" >Reset</Link>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div v-if="blogs.total">
                    <div class="flex" v-for="blog in blogs.data" :key="blog.id">
